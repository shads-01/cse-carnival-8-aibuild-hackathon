...
| 4 — Agent backend | `server/src/agent/tools.ts`, `systemPrompt.ts`, `runAgent.ts`, `POST /api/v1/agent/chat` | **In Progress** (`llmClient.ts` multi-key Gemini wrapper complete) |
